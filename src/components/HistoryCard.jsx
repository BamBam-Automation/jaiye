...
const HistoryCard = () => {
  return (
    <div className="relative">
      <img className="absolute w-full" src={History} alt="" />
      <div className="absolute w-full px-7 pt-8">
        <div className="relative font-semibold flex items-center justify-between text-[#848484]">
          <p>Owner</p>
